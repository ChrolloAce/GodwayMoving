            ...
            >
              {categories.map(category => (
                <button
                  ...
                  className={`px-6 py-3 rounded-full border transition-all duration-300 font-oswald uppercase ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredServices.map((service, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="group relative overflow-hidden rounded-xl shadow-lg transform hover:-translate-y-1 transition-all duration-300 border-2 border-godway-green1/20 bg-white"
                >
                  <Link href={`/services/${service.id}`} className="block relative w-full" style={{ height: "400px" }}>
                    <div className="absolute inset-x-0 top-0 z-20 bg-godway-green1 py-3 px-4 rounded-t-xl">
                      <h3 className="text-xl font-oswald text-white text-center uppercase font-bold">{service.title}</h3>
                    </div>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-godway-navy/90 to-transparent opacity-50 group-hover:opacity-70 transition-opacity duration-500"></div>
                    
                    <div className="absolute inset-x-0 bottom-0 p-6 text-white flex flex-col items-center transform translate-y-2 group-hover:translate-y-0 opacity-90 group-hover:opacity-100 transition-all duration-500 bg-godway-navy/80 rounded-b-xl">
                      ...
                      <div className="inline-flex items-center mt-4 text-godway-khaki hover:text-white font-oswald">
                        <span className="text-sm font-medium uppercase">Learn More</span>
