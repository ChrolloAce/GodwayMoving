      ...
      <div className="container-custom relative z-10">
        ...
        >
          <a 
            ...
            className="bg-godway-green1 text-white hover:bg-godway-green2 px-8 py-4 inline-flex items-center justify-center gap-2 shadow-lg rounded-full font-oswald transition-colors duration-300 uppercase"
          >
            <FaPhone />
            <span>Call Now</span>
          </a>
