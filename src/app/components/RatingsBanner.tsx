          ...
          <div className="flex flex-wrap justify-center md:justify-between md:w-2/3 gap-6 md:gap-2 lg:gap-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 font-oswald">856 reviews</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="font-bold text-xl md:text-2xl text-godway-green2">5/5</span>
                <p className="text-xs text-gray-600 font-oswald">734 reviews</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="font-bold text-xl md:text-2xl text-godway-green2">5/5</span>
                <p className="text-xs text-gray-600 font-oswald">946 reviews</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="font-bold text-xl md:text-2xl text-godway-green2">5/5</span>
                <p className="text-xs text-gray-600 font-oswald">684 reviews</p>
              </div>
            </div>
          </div>
        </motion.div>
