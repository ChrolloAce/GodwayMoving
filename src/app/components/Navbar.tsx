        ...
        <div className="flex justify-between items-center">
          ...
          >
            <a 
              ...
              className="bg-godway-khaki text-godway-navy hover:bg-godway-khaki/90 px-6 py-3 rounded-full font-oswald font-medium transition-colors shadow-military uppercase inline-flex items-center gap-2"
            >
      ...
      >
        <div className="container-custom py-4 bg-godway-green1 shadow-lg rounded-b-3xl">
          <div className="flex flex-col space-y-4">
            ...
            <a 
              href={`tel:${BusinessInfo.contact.phone.link}`}
              className="bg-godway-khaki text-godway-navy hover:bg-godway-khaki/90 py-3 px-6 rounded-full text-center font-oswald font-medium transition-colors shadow-military uppercase inline-flex items-center justify-center gap-2"
              onClick={() => setIsOpen(false)}
            >
              <FaPhone className="text-sm" />
              Call Now
